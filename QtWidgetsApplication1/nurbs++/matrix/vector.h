...
namespace PLib {
  ...
  template <class T> Vector<T> operator*(const Vector<T>& v, const Complex_hjy d);
		    
  template <class T> Vector<T> operator*(const double d,const Vector<T>& v) ;
  template <class T> Vector<T> operator*(const Complex_hjy d,const Vector<T>& v) ;

  template<> Vector<Complex_hjy>  operator*(const Vector<Complex_hjy>& v, const double d);
  template <> Vector<Complex_hjy>  operator*(const Vector<Complex_hjy>& v, const Complex_hjy d);
  ...
  */
  ...
  public:
    ...
    friend Vector<T> operator* <>(const Vector<T>& v, const Complex_hjy d);
    
    friend Vector<T> operator* <>(const double d,const Vector<T>& v) ;
    friend Vector<T> operator* <>(const Complex_hjy d,const Vector<T>& v) ;
  ...
  template<class T> inline 
    Vector<T>  operator*(const Complex_hjy d, const Vector<T>& v) //!< Multiplies by a Comples 
    {
      return v*d ;
    }
...
typedef PLib::Vector<Complex_hjy> Vector_COMPLEX ;
...
typedef PLib::Vector<Complex_hjy> PlVector_complex ;
