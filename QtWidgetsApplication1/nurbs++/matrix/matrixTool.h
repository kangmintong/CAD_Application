...
namespace PLib {
  ...
  inline Complex_hjy minimum(Complex_hjy a, Complex_hjy b){
    double r,i ;
    r = minimum(real(a),real(b)) ;
    i = minimum(imag(a),imag(b)) ;
    return Complex_hjy(r,i) ;
  }

  inline Complex_hjy maximum(Complex_hjy a, Complex_hjy b){
  double r,i ;
  ...
  inline Complex_hjy minimumByRef(const Complex_hjy &a, const Complex_hjy &b){
    double r,i ;
    r = minimum(real(a),real(b)) ;
    i = minimum(imag(a),imag(b)) ;
    return Complex_hjy(r,i) ;
  ...
  inline Complex_hjy maximumByRef(const Complex_hjy &a, const Complex_hjy &b){
    double r,i ;
    r = maximum(real(a),real(b)) ;
    i = maximum(imag(a),imag(b)) ;
    return Complex_hjy(r,i) ;
